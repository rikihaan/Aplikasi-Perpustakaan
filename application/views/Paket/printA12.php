...
<body>
  ...
  <body>
    <table class="table">
      ...
      <tr>
        <!-- no -->
        <td class="td4">JALUR PINDAH ORTU/BATAS/GTK</td>
        <!-- jumlah pendaftar -->
        <td class="td1"><?= $jumlahPendaftarLOrangTua + $jumlahPendaftarLPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarPOrangTua + $jumlahPendaftarPPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarLOrangTua + $jumlahPendaftarPOrangTua + $jumlahPendaftarLPerbatasan + $jumlahPendaftarPPerbatasan ?></td>

        <!-- jumalah ditemima -->
        <td class="td1"><?= $jumlahPendaftarLDiterimaOrangTua + $jumlahPendaftarLDiterimaPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarPDiterimaOrangTua + $jumlahPendaftarPDiterimaPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarLDiterimaOrangTua + $jumlahPendaftarPDiterimaOrangTua + $jumlahPendaftarLDiterimaPerbatasan + $jumlahPendaftarPDiterimaPerbatasan ?></td>

        <!-- jumalah tidak ditemima -->
        <td class="td1"><?= $jumlahPendaftarLTidakDiterimaOrangTua + $jumlahPendaftarLTidakDiterimaPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarPTidakDiterimaOrangTua + $jumlahPendaftarPTidakDiterimaPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarLTidakDiterimaOrangTua + $jumlahPendaftarPTidakDiterimaOrangTua + $jumlahPendaftarLTidakDiterimaPerbatasan + $jumlahPendaftarPTidakDiterimaPerbatasan ?></td>

        <!-- jumalah tidak verifikasi -->
        <td class="td1"><?= $jumlahPendaftarLTidakVerifikasiOrangTua + $jumlahPendaftarLTidakVerifikasiPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarPTidakVerifikasiOrangTua + $jumlahPendaftarPTidakVerifikasiPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarLTidakVerifikasiOrangTua + $jumlahPendaftarPTidakVerifikasiOrangTua + $jumlahPendaftarLTidakVerifikasiPerbatasan + $jumlahPendaftarPTidakVerifikasiPerbatasan ?></td>


        <!-- jumalah di cabut/ Pindah -->
        <td class="td1"><?= $jumlahPendaftarLPindahOrangTua + $jumlahPendaftarLPindahPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarPPindahOrangTua + $jumlahPendaftarPPindahPerbatasan ?></td>
        <td class="td1"><?= $jumlahPendaftarLPindahOrangTua + $jumlahPendaftarPPindahOrangTua + $jumlahPendaftarLPindahPerbatasan + $jumlahPendaftarPPindahPerbatasan ?></td>
      </tr>
