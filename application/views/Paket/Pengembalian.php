...
<div class="content">
    ...
    <div class="main d-flex flex-row justify-content-between">
        ...
        <div class="main-left">
            ...
            <input type="text" name="kedeBuku" id="inputKodeBukuPengembalianPaket" class="form-control inputKodeBukuPengembalianPaket" placeholder="input kode buku">
            ...
            <button class="button-reset-pengembalian-paket mr-5">Reset Pengembalian</button>
            <button class="button-proses btn-proses-kembali-paket">Proses Pengembalian</button>
        </div>
        <!-- main right -->
