...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <a href="<?= base_url('Pendaftar/GeneratePerbatasan') ?>" class="btn btn-outline-warning tombol-generatet">Generate <i class="fas fa-truck-loading"></i></a>
