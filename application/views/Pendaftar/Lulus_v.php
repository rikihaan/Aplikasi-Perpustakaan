          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu">
              <?php foreach ($jalur as $j) : ?>
                <a class="dropdown-item" href="<?= base_url('Pendaftar/cetakLulusByjalur/') . $j['id'] ?>" target="_Blank"><?= $j['ppdb']; ?></a>
            ...
            <tbody>
              ...
              foreach ($pendaftar as $daftar) : ?>
                <tr>
                  ...
                  <td><?= $daftar['ppdb'] ?></td>
                  <td>
                    <a href="<?= base_url('Pendaftar/printDataLulus/' . $daftar['koreg']); ?>" target="_Blank" class="badge badge-primary"><i class="fa fa-print" aria-hidden="true"></i> Cetak</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
