  ...
  foreach ($daftar as $pendaftar) { ?>
    ...
    <table>
      <tr>
        ...
        <td class="td3">:</td>
        <td><?= $pendaftar['namaSiswa'] ?></td>
      </tr>
      <tr>
        <td>Tempat, Tanggal Lahir</td>
        <td class="td3">:</td>
        <td><?= $pendaftar['tempatLahirSiswa'] . ', ' . date('d F Y', strtotime($pendaftar['tanggalLahirSiswa'])); ?></td>
      </tr>
      <tr>
        <td>NISN</td>
        <td class="td3">:</td>
      ...
      <tr>
        <td>Ayah</td>
        <td class="td3">:</td>
        <td><?= $pendaftar['namaAyah'] ?></td>
      </tr>
      <tr>
        <td>Ibu</td>
        <td class="td3">:</td>
        <td><?= $pendaftar['namaIbu'] ?></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="td3">:</td>
        <td><?= date('d F Y', strtotime($pendaftar['tanggalRegister'])) ?></td>
      </tr>
      <tr>
        <td>Jalur PPDB</td>
        <td class="td3">:</td>
        <td><?= $pendaftar['ppdb'] ?></td>
      </tr>
      <tr>
        <td>Kelompok Rombel</td>
        <td class="td3">:</td>
        <td><?= $pendaftar['kelRombel']; ?></td>
      </tr>
    </table>
    <div class="lulus">
      <p>DITERIMA</p>
    ...
    <div style="width: 90px; position:absolute; left:460px; top:820px;">
